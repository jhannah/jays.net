...
$blog_description = "Jay Hannah, Andria, Zach";
...
$url = "http://jays.net/blosxom/blosxom.cgi";
...
html date <br><font size=+1><b>$yr $mo $da ($dw)</b></font> &nbsp;&nbsp;&nbsp;&nbsp;<a href="/">[view all]</a></h3>\n
...
rss story   <item>\n    <title>$title</title>\n    <link>$url/$yr/$mo_num/$da#$fn</link>\n    <description>$body</description>\n  <pubDate>$lastmodified::story_rfc822</pubDate>  </item>\n
rss date \n
rss foot   </channel>\n</rss>
